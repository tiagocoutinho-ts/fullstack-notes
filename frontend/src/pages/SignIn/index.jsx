    ...
    <div className="min-h-screen container mx-auto px-6 py-6">
      ...
      <div className="max-w-md mx-auto mt-10 p-8 bg-white">
        ...
        <form className="flex flex-col gap-4">
          ...
          <button className="mt-2 bg-slate-600 hover:bg-slate-700 text-white font-semibold py-2 rounded-lg transition-colors shadow-md active:transform active:scale-[0.98]">
            Entrar
          </button>
        </form>
